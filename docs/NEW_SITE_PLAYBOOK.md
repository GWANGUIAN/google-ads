...
**Exception:** `img-convertor` keeps its existing dedicated domain (imgconvertor.download) — it's already deployed with domain connection in progress, not worth unwinding.
