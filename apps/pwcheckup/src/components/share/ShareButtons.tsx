    ...
    <div className="flex flex-wrap items-center gap-2">
      {KAKAO.jsKey && (
        <button
          type="button"
          onClick={handleKakao}
          className="inline-flex items-center gap-2 rounded-control bg-[#FEE500] px-4 py-2 text-sm font-semibold text-[#191919] hover:brightness-95"
        >
          <KakaoIcon />
          {t.share.kakao}
        </button>
      ...
      {webShareSupported && (
        <button
          ...
          className="inline-flex items-center gap-2 rounded-control bg-neutral-100 px-4 py-2 text-sm font-semibold text-neutral-900 hover:bg-neutral-200"
        >
          <ShareIcon />
          {t.share.native}
        </button>
