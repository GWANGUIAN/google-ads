...
export default function Dropzone({
  ...
  hint = "PNG, JPG, or any image containing a QR code",
}: {
  ...
  return (
    ...
    >
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-accent-500" aria-hidden="true">
